'''
todo_project/schema/response.py

서버가 클라이언트(사용자)에게 "돌려주는" 데이터의 형태를 정의하는 파일

request.py와 분리하는 이유
- 회원가입의 경우, "요청"에는 password가 있지만, "응답"에는 절대 포함하면 안되기 때문이다 (보안 사고 방지)
'''
