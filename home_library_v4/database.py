...
# os.getenv(변수이름, 기본값)
# - 컨테이너 실행 시 docker-compose.yml의 environment 항목에서 'DATABASE_URL' 환경변수를 넘겨주면 그 값을 사용한다
# - 만약 환경변수가 없으면(=로컬에서 바로 실행할 경우) 기존처럼 사용하기 위해 기본값을 넣을 때도 있다 (여기서는 생략)
#   - 기본값 : 'postgresql+psycopg2://postgres:1234@localhost:5432/home_library_v1'
