...
# football/schemas.py
# 
# API 응답으로 어떤 모양의 JSON을 내보낼지를 정의하는 파일
# 
# models.py의 SQLAlchemy 모델은 DB 테이블 구조를 표현
# schemas.py의 Pydantic 모델은 클라이언트에게 보여줄 응답 구조를 표현
# 
...
class Performance(BaseModel):
    ...
    FastAPI가 응답 모델 보고 ORM 객체의 속성을 읽어 JSON으로 바꾼다
    """
