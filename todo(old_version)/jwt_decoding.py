...
# - base64/json 표준 라이브러리만 사용해서 JWT가 암호화가 아니라
#   "인코딩 + 서명"이라는 것을 확인해보자
# ====================================================================
import base64
import json

token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoxMCwiZXhwIjoxNzg2MzQwOTA2fQ.DW2Pgs1rbQ3YbGvESPrKJDW8I9JDSpLay-vEyX_8P2U'

# 디코딩 테스트 용도의 실습이므로 이번에는 서명 부분 X → 밑줄로 받아서 무시
