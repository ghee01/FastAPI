...
from schema.request import IngredientCreate

router = APIRouter(tags=['Ingredient'])

@router.post("/ingredients/upload", status_code=status.HTTP_201_CREATED, summary="CSV 파일을 통한 식재료 데이터")
...
@router.get("/ingredients", response_model=List[IngredientResponse], summary="카테고리별 식재료 목록 조회")
