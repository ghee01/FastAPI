...
# Enum: 카테고리 허용값 제한
# str 상속 시 응답에서 "한식"이라는 문자열로 출력된다(보기가 좋다)
...
class MenuCreateRequest(BaseModel):
    ...
    # field_validator: 추가 유효성 검사 > price가 0 이하면 의미없는 데이터이므로 차단
...
def random_menu():
    ...
    """
    return random.choice(menus) # random.choice() - 선택
