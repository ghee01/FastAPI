...
| `busapidb` | `traffic_bus_event_alaerts` |
...
SELECT * FROM traffic_bus_event_alaerts ORDER BY detected_at DESC LIMIT 20;
```
...
- 같은 로직을 Spark SQL, Kafka, Flink, Esper, Hadoop, Hive 등과 같은 도구로 확장할 수 있다