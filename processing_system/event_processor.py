# =============================================================================================
# processing_system/event_processor.py
...
#       2) BUS_COORDINATE_OUT_OF_RANGE : 버스 정류소 좌표가 대구 범위를 벗어난 [이상데이터]이벤트
...
#         임계값, 날짜, 이름처럼 "데이터 값"을 바인딩한다
#         테이블명, 컬럼명, ASC/DESC 같은 "SQL 구조"는 보통 값 파라미터로 바인딩 할 수 없다
#         → 허용 목록(화이트 리스트)으로 검증
#   3) 멱등성(idempotency)
